...
class ProfileListAPIView(generics.ListAPIView):
    ...
    filterset_fields = ["occupation", "gender"]

    def get_queryset(self)-> List[Profile]:
        return (
            Profile.objects.exclude(user__is_staff=True).exclude(user__is_superuser=True).filter(occupation=Profile.Occupation.RESIDENT)
        )
